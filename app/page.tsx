import SignIn from "./auth/sign_in/page";
import SignUp from "./auth/sign_up/page";
import Link from "next/link";

export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between p-4 md:p-8 lg:p-12">
      <h1 className="text-md md:text-4xl lg:text-4xl font-extrabold mb-4 md:mb-6">Blog Post</h1>
      <div className="bg-gray-200 text-black p-4 md:p-6 lg:p-8 shadow-lg shadow-gray-400 rounded-xl w-full max-w-lg">
      <h1 className="text-center text-xl md:text-2xl lg:text-3xl font-bold border-b-4 border-blue-900">Wellcome To Our Blog Post</h1>
